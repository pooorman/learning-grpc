...
import tensorflow.serving.InferenceServiceGrpc;
...
/**
 * Created by jianghan on 2016/11/8.
 */
public class PredictClient {
    ...
    public static void main(String[] args) {
        ...
        PredictClient client = new PredictClient("localhost", 33024);
